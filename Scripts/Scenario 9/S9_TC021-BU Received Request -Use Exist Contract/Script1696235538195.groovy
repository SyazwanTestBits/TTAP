...
CustomKeywords.'copyToExcel.exel'(RequestNo, 1, 1, 'Excel Files\\Scenario 9', 'S9_TestCases_Data.xlsx', 'TC21-BU to Customer Contract')
...
WebUI.callTestCase(findTestCase('Scenario 9/S9_TC021.1-Get Contract Route Code'), [('contractNo') : findTestData('Scenario 9/S9_TC021-Contract Parts Info').getValue(
