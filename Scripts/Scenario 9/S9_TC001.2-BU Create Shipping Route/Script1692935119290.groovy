...
WebUI.callTestCase(findTestCase('Scenario 9/S9_TC001.2.1-Create Shipping Route ETD TransportDay ETA'), [('EtdWeekDay') : EtdWeekDay
...
WebUI.callTestCase(findTestCase('Scenario 9/S9_TC001.2.2-Create Shipping Route SF Week'), [('ShippingFrequency') : ShippingFrequency], 
    FailureHandling.STOP_ON_FAILURE)
