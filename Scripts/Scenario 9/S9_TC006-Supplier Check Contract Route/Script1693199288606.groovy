...
for (int rowl = 1; rowl <= numberrowtd; rowl++) {
    ...
    for (String colname : columnname) {
        String valuecol = findTestData('Scenario 9/S9_TC006-Supplier Contract Route').getValue(colname, rowl)
...
CustomKeywords.'verifyExcelData.verifyDynamicSort'('Excel Files\\Scenario 9\\Expected Data\\TC6\\Expected Contract Route Parts.xlsx', 
...
CustomKeywords.'verifyExcelData.verifyDynamicSort'('Excel Files\\Scenario 9\\Expected Data\\TC6\\Expected Contract Route Parts Overview.xlsx', 
