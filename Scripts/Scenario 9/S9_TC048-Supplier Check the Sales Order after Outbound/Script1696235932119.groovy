...
for (def index : (1..datafile_outbound.getRowNumbers())) {
    def deliveredQty = datafile_outbound.getValue('OutboundQty', index)
    ...
    WebUI.verifyElementText(findTestObject('Scenario 13/S13_TC050 TC053/partsDetail_InTransitQty', [('row') : index]), formattedDeliveredQty)
}
