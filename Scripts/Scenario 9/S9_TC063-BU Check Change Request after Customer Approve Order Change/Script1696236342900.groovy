...
int numberrowtd = findTestData('Scenario 9/S9_TC063-BU Check Change Details').getRowNumbers()

for (int rowl = 1; rowl <= numberrowtd; rowl++) {
	int coll = 1

	for (String col : columnname) {
		String valuecol = findTestData('Scenario 9/S9_TC063-BU Check Change Details').getValue(col, rowl)
