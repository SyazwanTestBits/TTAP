...
WebUI.click(findTestObject('Scenario 9/SC9_TC085/p_Outbound Monitoring List'))

WebUI.click(findTestObject('Scenario 9/SC9_TC085/button_Upload'))

CustomKeywords.'RobotUpload.uploadFile'(findTestObject('Scenario 9/SC9_TC085/li_Upload'), latestFilePath)
