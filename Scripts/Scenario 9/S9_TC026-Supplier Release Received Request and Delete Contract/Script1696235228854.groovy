...
WebUI.verifyElementText(findTestObject('Scenario 13/S13_TC035/Page_Brivge/div_RequestFrom'), GlobalVariable.S9_BAF_BU)
...
WebUI.click(findTestObject('Page_ReceivedReqList/Page_View Received Request Add New Part - Brivge/span_Delete the corresponding contract'), 
    FailureHandling.STOP_ON_FAILURE)
