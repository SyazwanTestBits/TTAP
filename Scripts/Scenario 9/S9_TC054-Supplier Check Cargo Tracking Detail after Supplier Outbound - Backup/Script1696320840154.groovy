...
for (def index : (1..datafile_outbound.getRowNumbers())) {
    ...
    WebUI.verifyElementPresent(findTestObject('Page_Cargo Tracking Detail - Brivge/p_PlannedETA_FinalDestination', [('bookingNo') : bookingNo
                , ('containerNo') : containerNo, ('eta') : eta]), 0)

    WebUI.verifyElementPresent(findTestObject('Page_Cargo Tracking Detail - Brivge/p_PredictiveETA_FinalDestination', [('bookingNo') : bookingNo
                , ('containerNo') : containerNo, ('eta') : eta]), 0)
