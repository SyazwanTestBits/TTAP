...
WebUI.click(findTestObject('Scenario 12/SC12_TC004/button_Back'))
...
WebUI.setText(findTestObject('Scenario 9/SC9_TC004/input__basicDescription'), contractDescription)
