...
WebUI.click(findTestObject('Scenario 10/S10_TC008/li_Contract List'))

WebUI.waitForElementPresent(findTestObject('Page_Contract List - Brivge/h3_Contract List'), 0)

WebUI.setText(findTestObject('Scenario 12/SC12_TC005/input_Contract List'), contractNo)

WebUI.verifyTextNotPresent(contractNo, false)
