...
for (int rowl = 1; rowl <= numberrowtd; rowl++) {
    ...
    for (String colname : columnname) {
        String valuecol = findTestData('Scenario 9/S9_TC005-BU Contract Route').getValue(colname, rowl)
...
CustomKeywords.'verifyExcelData.verifyDynamicSort'('Excel Files\\Scenario 9\\Expected Data\\TC5\\Expected Contract Route Parts.xlsx', 
    downloadedFile, 2, [5, 6, 7], [0, 2, 3, 5, 6, 7, 8, 9, 10, 11, 12, 14, 15, 16, 17, 18, 19, 20, 21])
...
CustomKeywords.'verifyExcelData.verifyDynamicSort'('Excel Files\\Scenario 9\\Expected Data\\TC5\\Expected Contract Route Parts Overview.xlsx', 
