...
WebUI.click(findTestObject('Scenario 9/SC9_TC008/button_row_Submit', [('requestNo') : RequestNo]), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('NotificationMsg_Brivge/div_NotiMsg_SubmitRequest_Success'), 0)

WebUI.verifyElementText(findTestObject('Scenario 9/SC9_TC008/p_verifyStatus', [('requestNo') : RequestNo]), 'Submitted')
