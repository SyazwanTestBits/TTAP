...
not_run: WebUI.click(findTestObject('Scenario 12/SC12_TC014/button_Download_CO'), FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.click(findTestObject('Scenario 12/SC12_TC014/li_Download by Excel'), FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.verifyElementPresent(findTestObject('Scenario 12/SC12_TC014/div_Download Sales Order by Excel.The operation was successful'), 
    0)

not_run: CustomKeywords.'ManageFiles.getLatestFileFromDirectory'('excel')
