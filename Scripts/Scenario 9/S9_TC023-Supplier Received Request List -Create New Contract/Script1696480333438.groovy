...
CustomKeywords.'copyToExcel.exel'(RequestNo, 1, 1, 'Excel Files\\Scenario 9', 'S9_TestCases_Data.xlsx', 'TC23-Supplier to BU Contract')

WebUI.setText(findTestObject('Scenario 13/S13_TC035/Page_Brivge/input_Filter_Received Request List'), routeDescription)
...
WebUI.callTestCase(findTestCase('Scenario 9/S9_TC023.1-Get Contract Route Code'), [('contractNo') : findTestData('Scenario 9/S9_TC023-SUP to BU Contract').getValue('ContractNo', 1)], 
    FailureHandling.STOP_ON_FAILURE)
