...
WebUI.callTestCase(findTestCase('0-Common/Login to Brivge'), [('url') : GlobalVariable.BRIVGE_URL, ('username') : GlobalVariable.BAF_USERNAME_FATIN
        , ('password') : GlobalVariable.ADMIN_PWD, ('verificationCode') : GlobalVariable.VERIFICATION_CODE, ('company') : GlobalVariable.S9_BAF_DC], 
...
WebUI.callTestCase(findTestCase('Scenario 9/S9_TC085.1-DC Outbound Details'), [('salesOrderNo') : findTestData('Scenario 9/S9_TC044-Autogen BU Sales Order').getValue(
            'OrderNo', 1), ('testdata_upload_outbounddata') : findTestData('Scenario 9/S9_TC085-DC Outbound'), ('buyer') : 'PK-CUS-POC'
        , ('receiver') : 'PK-CUS-POC', ('outboundType') : 'Outbound', ('shippingMode') : 'Sea', ('columnNames') : [('OutboundNo') : 3
            , ('OutboundDate') : 4, ('BookingNo') : 6, ('OutboundQty') : 9, ('ShippingMode') : 10, ('ETD') : 14, ('ETA') : 15
            , ('ContainerNo') : 16, ('ContainerType') : 17, ('CommodityType') : 18, ('SealNo') : 19, ('ContainerM3') : 20
            , ('ContainerNetWeight') : 21, ('ContainerGrossWeight') : 22, ('OuterPackageNo') : 23, ('OuterPackageType') : 24
            , ('OPM3') : 25, ('OPNetWeight') : 26, ('OPGrossWeight') : 27, ('InnerPackageNo') : 28, ('InnerPackageType') : 29
            , ('IPM3') : 30, ('IPNetWeight') : 31, ('IPGrossWeight') : 32], ('outboundDate') : '11/8/2023'], FailureHandling.STOP_ON_FAILURE)
...
for (int rowIndex = 1; rowIndex <= 1; rowIndex++) {
    ...
    CustomKeywords.'copyToExcel.exel'(outboundNo, rowIndex, 1, 'Excel Files\\Scenario 9', 'S9_TestCases_Data.xlsx', 'TC85-OutboundNo')
}
