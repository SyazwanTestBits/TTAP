...
int rownum = findTestData('Data Files/Scenario 17/S17_TC071 and TC072- Cargo Tracking Detail').getRowNumbers()
...
for (int row = 1; row <= rownum; row++) {
    String contnum2 = findTestData('Data Files/Scenario 17/S17_TC071 and TC072- Cargo Tracking Detail').getValue('ContainerNo', 
        row)
    ...
    String plannedETA = findTestData('Data Files/Scenario 17/S17_TC071 and TC072- Cargo Tracking Detail').getValue('TrackingType', 
        row)

    String predictiveETA = findTestData('Data Files/Scenario 17/S17_TC071 and TC072- Cargo Tracking Detail').getValue('TrackingType', 
        row)

    String lastEvent = findTestData('Data Files/Scenario 17/S17_TC071 and TC072- Cargo Tracking Detail').getValue('TrackingType', 
        row)

    String status = findTestData('Data Files/Scenario 17/S17_TC071 and TC072- Cargo Tracking Detail').getValue('TrackingType', 
        row)

    String trackType = findTestData('Data Files/Scenario 17/S17_TC071 and TC072- Cargo Tracking Detail').getValue('TrackingType', 
        row)
    ...
    for (String milestonecol : milestone) {
        String sytle2 = findTestData('Data Files/Scenario 17/S17_TC071 and TC072- Cargo Tracking Detail').getValue(milestonecol, 
            row)
