...
WebUI.verifyElementPresent(findTestObject('Scenario 17/S17_TC023/Page_Todo List - Brivge/div_Description_Customer', [('requestNo') : requestNo]), 
    0)

containsText = requestNo

elementText = WebUI.getText(findTestObject('Scenario 17/S17_TC023/Page_Todo List - Brivge/div_Description_Customer', [('requestNo') : requestNo]))
