...
int numberrowtd = findTestData('Scenario 17/S17_TC026- Parts Detail').getRowNumbers()

for (int rowl = 1; rowl <= numberrowtd; rowl++) {
    int coll = 1

    for (String col : columnname) {
        String valuecol = findTestData('Scenario 17/S17_TC026- Parts Detail').getValue(col, rowl)
