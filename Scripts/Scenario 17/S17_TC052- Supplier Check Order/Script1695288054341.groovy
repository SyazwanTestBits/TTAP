...
WebUI.verifyElementPresent(findTestObject('Scenario 17/S17_TC048/div_SupplierOrderNo', [('contractNo') : ContractNo, ('supplierOrderNo') : SalesOrderNo]), 
    0)

WebUI.setText(findTestObject('Scenario 12/SC12_TC014/input_contractNo'), SalesOrderNo)

WebUI.click(findTestObject('Scenario 12/SC12_TC014/input_checkall'))

WebUI.click(findTestObject('Scenario 17/S17_TC048/Page_SO Monitoring List - Brivge/button_Download_SOMonitoringList'))
...
nomatch = CustomKeywords.'util.compareTestData.compareExcelFiles'(LatestPath, absoluteExpectPath, 24, 28, 6, 18)
