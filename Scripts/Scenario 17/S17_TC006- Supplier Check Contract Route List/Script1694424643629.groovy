...
not_run: WebUI.verifyElementText(findTestObject('Scenario 9/SC9_TC003/p_verifyStatus', [('contractRouteCode') : contractRouteCode]), 
    'Build Completed')
...
not_run: WebUI.verifyElementText(findTestObject('Object Repository/Scenario 13/S13_TC038 n 39-Check Contract Route/h3_header view or edit Contract Route Detail'), 
...
not_run: for (int rowl = 1; rowl <= numberrowtd; rowl++) {
    ...
    for (String colname : columnname) {
        ...
        WebUI.verifyElementText(findTestObject('null', [('lcol') : colindex, ('lrow') : rowl]), 
            valuecol)
...
WebUI.callTestCase(findTestCase('0-Common/Common-Scenario 17/S17_Cmn3_Compare Test Data'), [('LatestPath') : latestFilePath
        , ('expectationExcelPath') : expectedContractRouteParts, ('startRows') : 6, ('endRows') : 8, ('startCols') : 1, ('endCols') : 22
...
WebUI.callTestCase(findTestCase('0-Common/Common-Scenario 17/S17_Cmn3_Compare Test Data'), [('LatestPath') : latestFilePath
        , ('expectationExcelPath') : expectedContractRoutePartsOverview, ('startRows') : 7, ('endRows') : 9, ('startCols') : 2
        , ('endCols') : 14, ('NumberOfNoMatch') : 0], FailureHandling.STOP_ON_FAILURE)
