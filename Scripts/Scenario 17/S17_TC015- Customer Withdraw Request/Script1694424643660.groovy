...
WebUI.click(findTestObject('Scenario 17/S17_TC015/p_withdrawButton', [('requestNo') : RequestNo]))

WebUI.verifyElementPresent(findTestObject('Scenario 17/S17_TC015/Page_Request List - Brivge/div_WithdrawAre you sure to do Withdraw(c0001)CANCELCONFIRM'), 
    0)

WebUI.click(findTestObject('Scenario 17/S17_TC003/Page_Request Remove Part - Brivge/span_CONFIRM'))

WebUI.verifyElementPresent(findTestObject('Scenario 17/S17_TC015/Page_Request List - Brivge/div_Cancel Request.The operation was successful'), 
    0)
