...
WebUI.scrollToElement(findTestObject('Scenario 17/S17_TC005/svg_Download Icon'), 
    0)

WebUI.click(findTestObject('Scenario 17/S17_TC005/svg_Download Icon'))

WebUI.click(findTestObject('Scenario 17/S17_TC005/li_Download Contract Parts'), 
    FailureHandling.STOP_ON_FAILURE)
