...
WebUI.click(findTestObject('Scenario 10/S10_TC074/button_Parts Monitoring detail_step_2'))

WebUI.scrollToElement(findTestObject('Scenario 10/S10_TC074/button_Download (1)'), 0)

WebUI.click(findTestObject('Scenario 10/S10_TC074/button_Download (1)'))

WebUI.click(findTestObject('Scenario 10/S10_TC074/li_Download Price'))

WebUI.verifyElementPresent(findTestObject('Scenario 10/S10_TC074/p_The operation was successful'), 0)

WebUI.click(findTestObject('Scenario 10/S10_TC074/button_Download (1)'))

WebUI.click(findTestObject('Scenario 10/S10_TC074/li_Download DR'))
