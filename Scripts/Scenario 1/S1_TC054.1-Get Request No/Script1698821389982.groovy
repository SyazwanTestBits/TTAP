...
WebUI.setText(findTestObject('Object Repository/Scenario 1/S1_TC031/input_textField'), contractRouteCode)

WebUI.click(findTestObject('Scenario 1/S1_TC031/button_requestType'))

WebUI.click(findTestObject('Scenario 1/S1_TC031/div_OrderChange'))

WebUI.click(findTestObject('Scenario 1/S1_TC031/button_OK'))

RequestNo = WebUI.getText(findTestObject('Scenario 1/S1_TC031/p_requestNo_firstRow'))

CustomKeywords.'copyToExcel.exel'(RequestNo, 1, 1, 'Excel Files\\Scenario 1', 'S1_TestCases_Data.xlsx', 'TC54-Change RequestNo')
