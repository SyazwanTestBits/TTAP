...
for (int row = 1; row <= 4; row++) {
    String bookingNo = findTestData('Data Files/Scenario 1/S1_TC189-Customer Cargo Tracking Details').getValue(
        'BookingNo', row)

    String contnum2 = findTestData('Data Files/Scenario 1/S1_TC189-Customer Cargo Tracking Details').getValue(
        'ContainerNo', row)
    ...
    String trackType = findTestData('Data Files/Scenario 1/S1_TC189-Customer Cargo Tracking Details').getValue(
        'TrackingType', row)
    ...
    for (String milestonecol : milestone) {
        String sytle2 = findTestData('Data Files/Scenario 1/S1_TC189-Customer Cargo Tracking Details').getValue(
            milestonecol, row)
