...
WebUI.callTestCase(findTestCase('0-Common/Login to Brivge'), [('url') : GlobalVariable.BRIVGE_URL, ('username') : GlobalVariable.BAF_USERNAME_SYAZWAN
        , ('password') : GlobalVariable.ADMIN_PWD, ('verificationCode') : GlobalVariable.VERIFICATION_CODE, ('company') : GlobalVariable.S1_BAF_BU2], 
...
WebUI.callTestCase(findTestCase('Scenario 1/S1_TC002.1-BU2 Create Shipping Route/S1_TC002.1-Create Shipping Route ETD TransportDay ETA'), 
...
WebUI.callTestCase(findTestCase('Scenario 1/S1_TC002.1-BU2 Create Shipping Route/S1_TC002.1-Create Shipping Route SF Week'), 
