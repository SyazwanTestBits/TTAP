...
for (int row = 1; row <= 4; row++) {
    String bookingNo = findTestData('Data Files/Scenario 1/S1_TC208.1-Customer Cargo Tracking -Regular').getValue('BookingNo', 
        row)

    String contnum2 = findTestData('Data Files/Scenario 1/S1_TC208.1-Customer Cargo Tracking -Regular').getValue('ContainerNo', 
        row)
    ...
    String trackType = findTestData('Data Files/Scenario 1/S1_TC208.1-Customer Cargo Tracking -Regular').getValue('TrackingType', 
        row)
    ...
    for (String milestonecol : milestone1_regular) {
        String sytle2 = findTestData('Data Files/Scenario 1/S1_TC208.1-Customer Cargo Tracking -Regular').getValue(milestonecol, 
            row)
...
for (int row = 1; row <= 3; row++) {
    String bookingNo = findTestData('Data Files/Scenario 1/S1_TC208.2-Customer Cargo Tracking -Regular').getValue('BookingNo', 
        row)

    String contnum2 = findTestData('Data Files/Scenario 1/S1_TC208.2-Customer Cargo Tracking -Regular').getValue('ContainerNo', 
        row)
    ...
    String trackType = findTestData('Data Files/Scenario 1/S1_TC208.2-Customer Cargo Tracking -Regular').getValue('TrackingType', 
        row)
    ...
    not_run: WebUI.verifyElementPresent(findTestObject('Scenario 13/S13_TC064,065/div_trackingType v1_1', [('maintitle') : mainforpath2
                , ('tracktype') : trackType]), 0)

    not_run: KeywordUtil.logInfo("VERIFIED TRACKING TYPE: $trackType")

    CustomKeywords.'util.ScrollToElement.clickUsingJS'(findTestObject('Scenario 13/S13_TC064,065/button_arrow_container more detail', 
            [('maintitle') : mainforpath2]), 1)

    for (String milestonecol : milestone2_regular) {
        String sytle2 = findTestData('Data Files/Scenario 1/S1_TC208.2-Customer Cargo Tracking -Regular').getValue(milestonecol, 
            row)
...
// Regular Order-3
for (int row = 1; row <= 3; row++) {
    String bookingNo = findTestData('Data Files/Scenario 1/S1_TC208.3-Customer Cargo Tracking -Regular').getValue('BookingNo', 
        row)

    String contnum2 = findTestData('Data Files/Scenario 1/S1_TC208.3-Customer Cargo Tracking -Regular').getValue('ContainerNo', 
        row)
    ...
    String trackType = findTestData('Data Files/Scenario 1/S1_TC208.3-Customer Cargo Tracking -Regular').getValue('TrackingType', 
        row)
    ...
    for (String milestonecol : milestone3_regular) {
        String sytle2 = findTestData('Data Files/Scenario 1/S1_TC208.3-Customer Cargo Tracking -Regular').getValue(milestonecol, 
            row)
