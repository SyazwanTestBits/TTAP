...
CustomKeywords.'verifyExcelData.verifyDynamicSort'('Excel Files\\Scenario 1\\Expected Data\\TC171\\Expected Sales Order.xlsx', 
...
int numberrowtd = findTestData('Scenario 1/S1_TC171-BU2 SO').getRowNumbers()

for (int rowl = 1; rowl <= numberrowtd; rowl++) {
    int coll = 1

    for (String colname : columnname) {
        String valuecol = findTestData('Scenario 1/S1_TC171-BU2 SO').getValue(colname, rowl)
