...
for (int rowIndex = 1; rowIndex <= 6; rowIndex++) {
    ...
    CustomKeywords.'copyToExcel.exel'(invoiceNo, rowIndex, 1, 'Excel Files\\Scenario 1', 'S1_TestCases_Data.xlsx', 'TC214-BU1 SellerGI Invoice')
}
...
for (int row = 1; row <= 6; row++) {
	...
	def invoiceNo = testData.getValue('InvoiceNo', row)
