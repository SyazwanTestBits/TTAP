...
for (int row = 1; row <= 2; row++) {
    String bookingNo = findTestData('Data Files/Scenario 1/S1_TC075.1-Supplier1 Cargo Tracking Details after Outbound').getValue('BookingNo', 
        row)

    String contnum2 = findTestData('Data Files/Scenario 1/S1_TC075.1-Supplier1 Cargo Tracking Details after Outbound').getValue('ContainerNo', 
        row)
    ...
    String trackType = findTestData('Data Files/Scenario 1/S1_TC075.1-Supplier1 Cargo Tracking Details after Outbound').getValue('TrackingType', 
        row)
    ...
    for (String milestonecol : milestone) {
        String sytle2 = findTestData('Data Files/Scenario 1/S1_TC075.1-Supplier1 Cargo Tracking Details after Outbound').getValue(milestonecol, 
            row)
...
for (int row = 1; row <= 1; row++) {
	String bookingNo = findTestData('Data Files/Scenario 1/S1_TC075.2-Supplier1 Cargo Tracking Details after Outbound').getValue('BookingNo',
		row)

	String contnum2 = findTestData('Data Files/Scenario 1/S1_TC075.2-Supplier1 Cargo Tracking Details after Outbound').getValue('ContainerNo',
		row)
	...
	String trackType = findTestData('Data Files/Scenario 1/S1_TC075.2-Supplier1 Cargo Tracking Details after Outbound').getValue('TrackingType',
		row)
	...
	for (String milestonecol : milestoneREALTIME) {
		String sytle2 = findTestData('Data Files/Scenario 1/S1_TC075.2-Supplier1 Cargo Tracking Details after Outbound').getValue(milestonecol,
			row)
...
for (int row = 1; row <= 1; row++) {
	String bookingNo = findTestData('Data Files/Scenario 1/S1_TC075.3-Supplier1 Cargo Tracking Details after Outbound').getValue('BookingNo',
		row)

	String contnum2 = findTestData('Data Files/Scenario 1/S1_TC075.3-Supplier1 Cargo Tracking Details after Outbound').getValue('ContainerNo',
		row)
	...
	String trackType = findTestData('Data Files/Scenario 1/S1_TC075.3-Supplier1 Cargo Tracking Details after Outbound').getValue('TrackingType',
		row)
	...
	for (String milestonecol : milestoneREALTIME2) {
		String sytle2 = findTestData('Data Files/Scenario 1/S1_TC075.3-Supplier1 Cargo Tracking Details after Outbound').getValue(milestonecol,
			row)
