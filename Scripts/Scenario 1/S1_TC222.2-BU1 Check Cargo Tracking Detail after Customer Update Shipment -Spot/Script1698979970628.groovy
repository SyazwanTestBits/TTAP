...
for (int row = 1; row <= 2; row++) {
    String bookingNo = findTestData('Data Files/Scenario 1/S1_TC221.1-Customer Cargo Tracking -Spot').getValue('BookingNo', 
        row)

    String contnum2 = findTestData('Data Files/Scenario 1/S1_TC221.1-Customer Cargo Tracking -Spot').getValue('ContainerNo', 
        row)
    ...
    String trackType = findTestData('Data Files/Scenario 1/S1_TC221.1-Customer Cargo Tracking -Spot').getValue('TrackingType', 
        row)
    ...
    for (String milestonecol : milestone1_spot) {
        String sytle2 = findTestData('Data Files/Scenario 1/S1_TC221.1-Customer Cargo Tracking -Spot').getValue(milestonecol, 
            row)
...
for (int row = 1; row <= 1; row++) {
    String bookingNo = findTestData('Data Files/Scenario 1/S1_TC221.2-Customer Cargo Tracking -Spot').getValue('BookingNo', 
        row)

    String contnum2 = findTestData('Data Files/Scenario 1/S1_TC221.2-Customer Cargo Tracking -Spot').getValue('ContainerNo', 
        row)
    ...
    String trackType = findTestData('Data Files/Scenario 1/S1_TC221.2-Customer Cargo Tracking -Spot').getValue('TrackingType', 
        row)
    ...
    for (String milestonecol : milestone2_spot) {
        String sytle2 = findTestData('Data Files/Scenario 1/S1_TC221.2-Customer Cargo Tracking -Spot').getValue(milestonecol, 
            row)
...
//SPOT ORDER-3
for (int row = 1; row <= 1; row++) {
    String bookingNo = findTestData('Data Files/Scenario 1/S1_TC221.3-Customer Cargo Tracking -Spot').getValue('BookingNo', 
        row)

    String contnum2 = findTestData('Data Files/Scenario 1/S1_TC221.3-Customer Cargo Tracking -Spot').getValue('ContainerNo', 
        row)
    ...
    String trackType = findTestData('Data Files/Scenario 1/S1_TC221.3-Customer Cargo Tracking -Spot').getValue('TrackingType', 
        row)
    ...
    for (String milestonecol : milestone3_spot) {
        String sytle2 = findTestData('Data Files/Scenario 1/S1_TC221.3-Customer Cargo Tracking -Spot').getValue(milestonecol, 
            row)
...
for (int row = 1; row <= 3; row++) {
    String bookingNo = findTestData('Data Files/Scenario 1/S1_TC221.4-Customer Cargo Tracking -Spot').getValue('BookingNo', 
        row)

    String contnum2 = findTestData('Data Files/Scenario 1/S1_TC221.4-Customer Cargo Tracking -Spot').getValue('ContainerNo', 
        row)
    ...
    String trackType = findTestData('Data Files/Scenario 1/S1_TC221.4-Customer Cargo Tracking -Spot').getValue('TrackingType', 
        row)
    ...
    for (String milestonecol : milestone4_spot) {
        String sytle2 = findTestData('Data Files/Scenario 1/S1_TC221.4-Customer Cargo Tracking -Spot').getValue(milestonecol, 
            row)
...
//SPOT ORDER-5
for (int row = 1; row <= 3; row++) {
    String bookingNo = findTestData('Data Files/Scenario 1/S1_TC221.5-Customer Cargo Tracking -Spot').getValue('BookingNo', 
        row)

    String contnum2 = findTestData('Data Files/Scenario 1/S1_TC221.5-Customer Cargo Tracking -Spot').getValue('ContainerNo', 
        row)
    ...
    String trackType = findTestData('Data Files/Scenario 1/S1_TC221.5-Customer Cargo Tracking -Spot').getValue('TrackingType', 
        row)
    ...
    for (String milestonecol : milestone5_spot) {
        String sytle2 = findTestData('Data Files/Scenario 1/S1_TC221.5-Customer Cargo Tracking -Spot').getValue(milestonecol, 
            row)
