...
CustomKeywords.'verifyExcelData.verifyDynamicSort'('Excel Files\\Scenario 1\\Expected Data\\TC87\\Expected Customer Order.xlsx', 
...
int numberrowtd = findTestData('Scenario 1/S1_TC087-Customer CO Details').getRowNumbers()

for (int rowl = 1; rowl <= numberrowtd; rowl++) {
    int coll = 1

    for (String col : columnname) {
        String valuecol = findTestData('Scenario 1/S1_TC087-Customer CO Details').getValue(col, rowl)
