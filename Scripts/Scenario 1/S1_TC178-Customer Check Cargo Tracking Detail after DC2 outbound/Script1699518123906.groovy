...
for (int row = 1; row <= 4; row++) {
    String bookingNo = findTestData('Data Files/Scenario 1/S1_TC178').getValue(
        'BookingNo', row)

    String contnum2 = findTestData('Data Files/Scenario 1/S1_TC178').getValue(
        'ContainerNo', row)
    ...
    String trackType = findTestData('Data Files/Scenario 1/S1_TC178').getValue(
        'TrackingType', row)
    ...
    for (String milestonecol : milestone) {
        String sytle2 = findTestData('Data Files/Scenario 1/S1_TC178').getValue(
            milestonecol, row)
