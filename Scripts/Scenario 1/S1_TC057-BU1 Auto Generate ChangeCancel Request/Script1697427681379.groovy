...
KeywordUtil.logInfo("Verified Request No: $Supplier2_RequestNo Request Type: Order Change Status: New")
...
WebUI.verifyElementAttributeValue(findTestObject('Scenario 1/S1_TC062/Page_ChangeCancel Request Detail - Brivge/input_Request Detail Information_contractNo'), 
    'value', BU1toCustomer_Contract, 0)

WebUI.click(findTestObject('Scenario 12/SC12_TC035/li_ChangeCancel Request List'))

WebUI.setText(findTestObject('Scenario 1/S1_TC062/input_ChangeCancel RequestNo'), Supplier1_RequestNo)

'Verify Order Cancel with Status = New'
WebUI.verifyElementText(findTestObject('Scenario 1/S1_TC062/p_Cancel', [('requestNo') : Supplier1_RequestNo]), 'New')

KeywordUtil.logInfo("Verified Request No: $Supplier1_RequestNo Request Type: Order Change Status: New")
