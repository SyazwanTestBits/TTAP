...
WebUI.verifyElementText(findTestObject('Scenario 1/S1_TC034/p_requestFrom', [('row') : 1]), GlobalVariable.S1_BAF_SUP2)

WebUI.verifyElementText(findTestObject('Scenario 1/S1_TC034/p_requestType', [('row') : 1]), 'Order Change')
