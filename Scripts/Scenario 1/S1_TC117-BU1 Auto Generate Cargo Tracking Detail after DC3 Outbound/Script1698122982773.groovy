...
for (int row = 1; row <= 2; row++) {
    String bookingNo = findTestData('Data Files/Scenario 1/S1_TC116.1-Customer Cargo Tracking Details').getValue('BookingNo', 
        row)

    String contnum2 = findTestData('Data Files/Scenario 1/S1_TC116.1-Customer Cargo Tracking Details').getValue('ContainerNo', 
        row)
    ...
    String trackType = findTestData('Data Files/Scenario 1/S1_TC116.1-Customer Cargo Tracking Details').getValue('TrackingType', 
        row)
    ...
    for (String milestonecol : milestone) {
        String sytle2 = findTestData('Data Files/Scenario 1/S1_TC116.1-Customer Cargo Tracking Details').getValue(milestonecol, 
            row)
...
for (int row = 1; row <= 1; row++) {
    String bookingNo = findTestData('Data Files/Scenario 1/S1_TC116.2-Customer Cargo Tracking Details').getValue('BookingNo', 
        row)

    String contnum2 = findTestData('Data Files/Scenario 1/S1_TC116.2-Customer Cargo Tracking Details').getValue('ContainerNo', 
        row)
    ...
    String trackType = findTestData('Data Files/Scenario 1/S1_TC116.2-Customer Cargo Tracking Details').getValue('TrackingType', 
        row)
    ...
    for (String milestonecol : milestoneREALTIME) {
        String sytle2 = findTestData('Data Files/Scenario 1/S1_TC116.2-Customer Cargo Tracking Details').getValue(milestonecol, 
            row)
...
for (int row = 1; row <= 1; row++) {
    String bookingNo = findTestData('Data Files/Scenario 1/S1_TC116.3-Customer Cargo Tracking Details').getValue('BookingNo', 
        row)

    String contnum2 = findTestData('Data Files/Scenario 1/S1_TC116.3-Customer Cargo Tracking Details').getValue('ContainerNo', 
        row)
    ...
    String trackType = findTestData('Data Files/Scenario 1/S1_TC116.3-Customer Cargo Tracking Details').getValue('TrackingType', 
        row)
    ...
    for (String milestonecol : milestoneREALTIME2) {
        String sytle2 = findTestData('Data Files/Scenario 1/S1_TC116.3-Customer Cargo Tracking Details').getValue(milestonecol, 
            row)
...
for (int row = 1; row <= 3; row++) {
    String bookingNo = findTestData('Data Files/Scenario 1/S1_TC116.4-Customer Cargo Tracking Details').getValue('BookingNo', 
        row)

    String contnum2 = findTestData('Data Files/Scenario 1/S1_TC116.4-Customer Cargo Tracking Details').getValue('ContainerNo', 
        row)
    ...
    String trackType = findTestData('Data Files/Scenario 1/S1_TC116.4-Customer Cargo Tracking Details').getValue('TrackingType', 
        row)
    ...
    for (String milestonecol : milestone2) {
        String sytle2 = findTestData('Data Files/Scenario 1/S1_TC116.4-Customer Cargo Tracking Details').getValue(milestonecol, 
            row)
