...
WebUI.verifyElementAttributeValue(findTestObject('Scenario 1/S1_TC034/input_PO'), 'value', BU2_PO, 0)
...
WebUI.verifyElementAttributeValue(findTestObject('Scenario 1/S1_TC034/input_Seller'), 'value', '', 0)

WebUI.verifyElementAttributeValue(findTestObject('Scenario 1/S1_TC034/input_Buyer'), 'value', '', 0)

WebUI.verifyElementAttributeValue(findTestObject('Scenario 1/S1_TC034/input_ContractNo'), 'value', '', 0)

WebUI.verifyElementAttributeValue(findTestObject('Scenario 1/S1_TC034/input_PO'), 'value', '', 0)
