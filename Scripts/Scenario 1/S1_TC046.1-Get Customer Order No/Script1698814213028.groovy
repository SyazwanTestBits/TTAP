...
OrderNo = WebUI.getText(findTestObject('Scenario 1/S1_TC015/Page_CO Monitoring List - Brivge/p_orderNo_secondRow'))

CustomKeywords.'copyToExcel.exel'(OrderNo, 1, 0, 'Excel Files\\Scenario 1', 'S1_TestCases_Data.xlsx', 'TC47-Autogen OrderNo Spot')
