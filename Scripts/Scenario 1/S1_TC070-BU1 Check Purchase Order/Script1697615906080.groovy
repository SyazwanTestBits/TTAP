...
WebUI.scrollToElement(findTestObject('Scenario 1/S1_TC068/div_Order Qty'), 0)
...
actualOrderQTY = WebUI.getText(findTestObject('Scenario 1/S1_TC068/div_Order Qty (Amount)'))
