...
CustomKeywords.'copyToExcel.exel'(contractNo, 1, 2, 'Excel Files\\Scenario 1', 'S1_TestCases_Data.xlsx', 'TC028')

contractRouteCode = WebUI.getText(findTestObject('Scenario 1/S1_TC027/p_Contract Route Code'))

println(contractRouteCode)

CustomKeywords.'copyToExcel.exel'(contractRouteCode, 1, 3, 'Excel Files\\Scenario 1', 'S1_TestCases_Data.xlsx', 'TC028')
