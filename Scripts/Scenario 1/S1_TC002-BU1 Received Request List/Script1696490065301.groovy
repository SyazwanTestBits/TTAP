...
CustomKeywords.'copyToExcel.exel'(RequestNo, 1, 1, 'Excel Files\\Scenario 1', 'S1_TestCases_Data.xlsx', 'TC2-BU1 to Customer Contract')
...
WebUI.click(findTestObject('Page_ReceivedReqList/Page_Received Request Add New Part - Brivge/input_ADD DISTRIBUTION CENTER_autoDiFlag'))

WebUI.click(findTestObject('Page_ReceivedReqList/Page_Received Request Add New Part - Brivge/li_AutoDI', [('autoDIFlag') : autoDIFlag]))
...
WebUI.setText(findTestObject('Scenario 1/S1_TC002/Page_Received Request Add New Part - Brivge/input_SUBMIT REQUEST TO SG-TTAP_description'), 
    BU2_Description)

WebUI.setText(findTestObject('Scenario 1/S1_TC002/Page_Received Request Add New Part - Brivge/input_SUBMIT REQUEST TO MY-PNA-BU_description'), 
    BU3_Description)
...
CustomKeywords.'copyToExcel.exel'(ContractRouteCode, 1, 23, 'Excel Files\\Scenario 1', 'S1_TestCases_Data.xlsx', 'TC2-BU1 to Customer Contract')
