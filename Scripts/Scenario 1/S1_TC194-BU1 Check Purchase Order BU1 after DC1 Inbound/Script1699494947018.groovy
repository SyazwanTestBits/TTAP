...
int numberrowtd = findTestData('Scenario 1/S1_TC194-Shipping Info').getRowNumbers()

for (int rowl = 1; rowl <= numberrowtd; rowl++) {
    int coll = 1

    for (String colname : columnname) {
        String valuecol = findTestData('Scenario 1/S1_TC194-Shipping Info').getValue(colname, rowl)
