...
for (int row = 1; row <= 2; row++) {
    String bookingNo = findTestData('Data Files/Scenario 1/S1_TC106.1-Supplier1 Cargo Tracking Details after DC3 Inbound').getValue('BookingNo', 
        row)

    String contnum2 = findTestData('Data Files/Scenario 1/S1_TC106.1-Supplier1 Cargo Tracking Details after DC3 Inbound').getValue('ContainerNo', 
        row)
    ...
    String trackType = findTestData('Data Files/Scenario 1/S1_TC106.1-Supplier1 Cargo Tracking Details after DC3 Inbound').getValue('TrackingType', 
        row)
    ...
    for (String milestonecol : milestone) {
        String sytle2 = findTestData('Data Files/Scenario 1/S1_TC106.1-Supplier1 Cargo Tracking Details after DC3 Inbound').getValue(milestonecol, 
            row)
...
for (int row = 1; row <= 1; row++) {
	String bookingNo = findTestData('Data Files/Scenario 1/S1_TC106.2-Supplier1 Cargo Tracking Details after DC3 Inbound').getValue('BookingNo',
		row)

	String contnum2 = findTestData('Data Files/Scenario 1/S1_TC106.2-Supplier1 Cargo Tracking Details after DC3 Inbound').getValue('ContainerNo',
		row)
	...
	String trackType = findTestData('Data Files/Scenario 1/S1_TC106.2-Supplier1 Cargo Tracking Details after DC3 Inbound').getValue('TrackingType',
		row)
	...
	for (String milestonecol : milestoneREALTIME) {
		String sytle2 = findTestData('Data Files/Scenario 1/S1_TC106.2-Supplier1 Cargo Tracking Details after DC3 Inbound').getValue(milestonecol,
			row)
...
for (int row = 1; row <= 1; row++) {
	String bookingNo = findTestData('Data Files/Scenario 1/S1_TC106.3-Supplier1 Cargo Tracking Details after DC3 Inbound').getValue('BookingNo',
		row)

	String contnum2 = findTestData('Data Files/Scenario 1/S1_TC106.3-Supplier1 Cargo Tracking Details after DC3 Inbound').getValue('ContainerNo',
		row)
	...
	String trackType = findTestData('Data Files/Scenario 1/S1_TC106.3-Supplier1 Cargo Tracking Details after DC3 Inbound').getValue('TrackingType',
		row)
	...
	for (String milestonecol : milestoneREALTIME2) {
		String sytle2 = findTestData('Data Files/Scenario 1/S1_TC106.3-Supplier1 Cargo Tracking Details after DC3 Inbound').getValue(milestonecol,
			row)
