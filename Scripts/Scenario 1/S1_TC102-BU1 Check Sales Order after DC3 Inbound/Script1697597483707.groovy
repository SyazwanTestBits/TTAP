...
CustomKeywords.'verifyExcelData.verifyDynamicSort'('Excel Files\\Scenario 1\\Expected Data\\TC102\\Expected Sales Order.xlsx', 
...
int numberrowtd = findTestData('Scenario 1/S1_TC102-BU1 SO Details after DC3 Inbound').getRowNumbers()

for (int rowl = 1; rowl <= numberrowtd; rowl++) {
    int coll = 1

    for (String colname : columnname) {
        String valuecol = findTestData('Scenario 1/S1_TC102-BU1 SO Details after DC3 Inbound').getValue(colname, rowl)
...
CustomKeywords.'util.ScrollToElement.clickUsingJS'(findTestObject('Scenario 1/S1_TC101/Page_SO Monitoring Detail - Brivge/p_SO Monitoring List'), 
    0)
