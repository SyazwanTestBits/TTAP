...
not_run: WebUI.waitForElementVisible(findTestObject('NotificationMsg_Brivge/div_NotiMsg_AreYouSureToDo_Release'), 0)

not_run: WebUI.click(findTestObject('NotificationMsg_Brivge/button_NotiMsg_CONFIRM'))

not_run: WebUI.verifyElementPresent(findTestObject('NotificationMsg_Brivge/div_NotiMsg_DoRelease_Success'), 0)
