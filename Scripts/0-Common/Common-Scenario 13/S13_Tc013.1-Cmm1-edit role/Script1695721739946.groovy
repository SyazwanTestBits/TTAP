...
WebUI.verifyElementText(findTestObject('Page_UserList/Page_CreateNewUser/div_Dt_CompanyInfo_CompanyCode', [('userCompany') : company]), 
    company)

not_run: WebUI.click(findTestObject('Page_UserList/Page_CreateNewUser/div_Dt_CompanyInfo_CompanyCode - edit Role', [('userCompany') : company]))

CustomKeywords.'util.ScrollToElement.clickUsingJS'(findTestObject('Page_UserList/Page_CreateNewUser/div_Dt_CompanyInfo_CompanyCode - edit Role', 
