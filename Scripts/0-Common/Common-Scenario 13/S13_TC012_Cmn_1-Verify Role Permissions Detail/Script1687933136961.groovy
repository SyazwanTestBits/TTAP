...
WebUI.click(findTestObject('Page_Request Add New Part - Brivge/Page_RoleList/button_Dt_ViewRoleDetails', [('roleName') : RoleName]))

CustomKeywords.'ExcelActions.verifyCopyRolePermissionList'(CopyRoleAs)
