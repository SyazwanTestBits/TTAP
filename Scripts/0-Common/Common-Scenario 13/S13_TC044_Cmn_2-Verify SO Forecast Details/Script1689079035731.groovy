...
WebUI.click(findTestObject('Page_SO_MonitoringList/button_Dt_Forecast', [('contractNo') : contractNo]))

WebUI.waitForElementPresent(findTestObject('Page_SO_ForecastDetail/h3_SO Forecast Detail'), 0)

WebUI.verifyElementAttributeValue(findTestObject('Page_SO_ForecastDetail/input_SalesOrderNo'), 'value', salesOrderNo, 0)
