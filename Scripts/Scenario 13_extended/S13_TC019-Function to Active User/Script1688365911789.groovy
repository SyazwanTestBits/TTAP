...
WebUI.verifyElementText(findTestObject('Page_UserList/p_Dt_UserList_Status', [('username') : username]), 'Inactive', FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('0-Common/Common-Scenario 13/S13_TC019_Cmn_1-Verify User Status Active'), [('username') : username], 
    FailureHandling.STOP_ON_FAILURE)
...
s13excel_abspath = CustomKeywords.'ManageFiles.getFileAbsolutePath'('Excel Files/Scenario 13/S13_TestCases_Data.xlsx')

CustomKeywords.'copyToExcel.exel2'(userVerifCode, 1, 7, s13excel_abspath, 'TC019-Activate User')
