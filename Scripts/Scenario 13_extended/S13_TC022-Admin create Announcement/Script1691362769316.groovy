...
String classminutePointer = ''

if ((currentMinute % 5) == 0) {
    classminutePointer = 'lcbm-MuiPickersClockPointer-thumb lcbm-MuiPickersClockPointer-noPoint'
} else {
    classminutePointer = 'lcbm-MuiPickersClockPointer-thumb'
}
...
WebUI.setText(findTestObject('Scenario 13/S13_TC022 and TC23/Create announcement/input_CUSTOM-user-search user'), 'userf syazwanemail')
