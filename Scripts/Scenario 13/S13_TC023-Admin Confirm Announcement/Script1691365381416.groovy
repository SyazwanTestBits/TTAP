...
WebUI.click(findTestObject('Scenario 13/S13_TC022 and TC23/Create announcement/button_announcement confirm'))

WebUI.verifyElementText(findTestObject('Scenario 13/S13_TC022 and TC23/p_operation was successful-confirm announcer'), 'The operation was successful.')

WebUI.back()

WebUI.setText(findTestObject('Scenario 13/S13_TC022 and TC23/input_Announcement List search'), announcement_header)

WebUI.verifyElementText(findTestObject('Scenario 13/S13_TC022 and TC23/div_status'), 'CONFIRMED')
