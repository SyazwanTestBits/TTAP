...
WebUI.setText(findTestObject('Page_OutboundMonitoringList/input_OutboundNo_Search'), outboundNoRef)

WebUI.click(findTestObject('Page_OutboundMonitoringList/button_Dt_Row_ViewOutboundDetail', [('outboundNoRef') : outboundNoRef]))
