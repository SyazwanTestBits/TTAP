...
WebUI.verifyElementText(findTestObject('Page_CustomsInvoice_Import/div_Dt_InvoiceNo_Import', [('invoiceNo') : invoiceNo]),
	invoiceNo)

WebUI.verifyElementText(findTestObject('Page_CustomsInvoice_Import/div_Dt_CargoStatus_Import', [('invoiceNo') : invoiceNo]),
	cargoStatus)

WebUI.verifyElementText(findTestObject('Page_CustomsInvoice_Import/div_Dt_Status_Import', [('invoiceNo') : invoiceNo]),
	status)
