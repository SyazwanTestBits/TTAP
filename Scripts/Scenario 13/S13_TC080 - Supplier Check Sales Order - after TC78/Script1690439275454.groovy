...
WebUI.verifyElementText(findTestObject('Scenario 13/S13_TC050 TC053/div_SO status'), 'Completed')
...
int numberrowtd = findTestData('Scenario 13/S13_TC080').getRowNumbers()

for (int rowl = 1; rowl <= numberrowtd; rowl++) {
    int coll = 1

    for (String col : columnname) {
        String valuecol = findTestData('Scenario 13/S13_TC080').getValue(col, rowl)
