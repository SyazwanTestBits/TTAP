...
WebUI.callTestCase(findTestCase('0-Common/Common-Scenario 13/S13_TC044_Cmn_1-Verify and Download SO Details'), [('contractNo') : contractNo
        , ('salesOrderNo') : salesOrderNo], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('0-Common/Common-Scenario 13/S13_TC044_Cmn_2-Verify SO Forecast Details'), [('contractNo') : contractNo
        , ('salesOrderNo') : salesOrderNo], FailureHandling.STOP_ON_FAILURE)
