...
WebUI.click(findTestObject('Scenario 13/S13_TC002/Page_Brivge/button_Download'))

'Select download'
WebUI.click(findTestObject('Scenario 13/S13_TC002/Page_Brivge/li_Download Port Master'))

'Verify that the file has been downloaded.'
WebUI.verifyElementPresent(findTestObject('Scenario 13/S13_TC002/Page_Brivge/div_Download Port master By filters.The operation was successful'), 
    0)
