...
WebUI.callTestCase(findTestCase('Scenario 13/S13_TC033-Create Shipping Route folder/S13_TC033.1-Create Shipping Route ETD TransportDay ETA'), 
...
WebUI.callTestCase(findTestCase('Scenario 13/S13_TC033-Create Shipping Route folder/S13_TC033.1-Create Shipping Route SF Week'), 
