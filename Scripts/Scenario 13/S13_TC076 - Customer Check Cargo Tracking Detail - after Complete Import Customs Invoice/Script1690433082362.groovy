...
int rownum = findTestData('Data Files/Scenario 13/S13_TC076n077_Forecast').getRowNumbers()

'For Forecast Container'
for (int r = 1; r <= rownum; r++) {
   
	String contnum = findTestData('Data Files/Scenario 13/S13_TC076n077_Forecast').getValue('ContainerNo', r)
	...
	String trackType = findTestData('Data Files/Scenario 13/S13_TC076n077_Forecast').getValue('TrackingType', r)
	...
	for (String milestoneforce : milestoneREALTIME) {
		String sytle = findTestData('Data Files/Scenario 13/S13_TC076n077_Forecast').getValue(milestoneforce, r)
...
int numrowForecastManual = findTestData('Data Files/Scenario 13/S13_TC076n077_Forecast-Manual').getRowNumbers()

'For Forecast: MANUAL'
for (int row11 = 1; row11 <= numrowForecastManual; row11++) {
	String contnum11 = findTestData('Data Files/Scenario 13/S13_TC076n077_Forecast-Manual').getValue('ContainerNo', row11)
	...
	String trackType11 = findTestData('Data Files/Scenario 13/S13_TC076n077_Forecast-Manual').getValue('TrackingType', row11)
	...
	for (String milestoneforce11 : milestoneREALTIME) {
		String sytle11 = findTestData('Data Files/Scenario 13/S13_TC076n077_Forecast-Manual').getValue(milestoneforce11,
			row11)
...
int numrowNonForecast = findTestData('Data Files/Scenario 13/S13_TC076n077_NonForecast').getRowNumbers()
...
for (int row2 = 1; row2 <= numrowNonForecast; row2++) {
		...
		String trackType = findTestData('Data Files/Scenario 13/S13_TC076n077_NonForecast').getValue('TrackingType', row2)
		...
		for (String milestonecol : milestone) {
			String sytle2 = findTestData('Data Files/Scenario 13/S13_TC076n077_NonForecast').getValue(milestonecol, row2)
