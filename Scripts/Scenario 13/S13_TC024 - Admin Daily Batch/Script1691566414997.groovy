...
WebUI.click(findTestObject('Page_Batch/li_DAILY BATCH'))

WebUI.verifyElementPresent(findTestObject('NotificationMsg_Brivge/div_NotiMsg_Check ToDo List_Success'), 0)
