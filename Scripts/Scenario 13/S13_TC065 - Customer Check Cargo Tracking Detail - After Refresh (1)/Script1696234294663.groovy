...
for (int r = 1; r <= rownum; r++) {
    ...
    String trackType = findTestData('Data Files/Scenario 13/S13_TC064-065_Forecast').getValue('TrackingType', r)
    ...
    for (String milestoneforce : milestoneREALTIME) {
        String sytle = findTestData('Data Files/Scenario 13/S13_TC064-065_Forecast').getValue(milestoneforce, r)
...
for (int row2 = 1; row2 <= numrowNonForecast; row2++) {
    ...
    for (String milestonecol : milestone) {
        String sytle2 = findTestData('Data Files/Scenario 13/S13_TC064-065_NonForecast').getValue(milestonecol, row2)
