...
'NEED TO CHECK'
WebUI.verifyElementAttributeValue(findTestObject('Scenario 13/S13_TC049 TC054/input_status CO_verify'), 'value', findTestData('Scenario 13/S13_TC079').getValue('CO status', 1),
0)
