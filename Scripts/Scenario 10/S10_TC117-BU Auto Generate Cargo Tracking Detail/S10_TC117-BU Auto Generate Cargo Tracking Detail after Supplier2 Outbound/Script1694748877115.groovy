...
WebUI.callTestCase(findTestCase('Scenario 10/S10_TC117-BU Auto Generate Cargo Tracking Detail/S10_TC117.1-BU Cargo Tracking (Bs2-NT-01-001 C-230608001)'), 
...
WebUI.callTestCase(findTestCase('Scenario 10/S10_TC117-BU Auto Generate Cargo Tracking Detail/S10_TC117.2-BU Cargo Tracking (JP-YAZ-C-230608001)'), 
    [('milestone') : ['Booking Submitted', 'Booking Confirmed', 'Empty Container Release to Shipper', 'Cargo Outbound', 'Gate in (arrival at first POL)'
            , 'Container loaded at first POL', 'Vessel departure from first POL', 'Vessel arrival at T/S port', 'Container discharge at T/S port'
            , 'Container loaded at T/S port', 'Vessel departure from T/S', 'Exp clearance in progress', 'Exp clearance completed'
            , 'Exp clearance in progress', 'Exp clearance completed', 'Imp clearance in progress', 'Imp clearance completed'
...
WebUI.callTestCase(findTestCase('Scenario 10/S10_TC117-BU Auto Generate Cargo Tracking Detail/S10_TC117.3-BU Cargo Tracking (EGSU9073529)'), 
    [('milestone') : ['Booking Submitted', 'Booking Confirmed', 'Empty Container Release to Shipper', 'Cargo Outbound', 'Gate in (arrival at first POL)'
            , 'Container loaded at first POL', 'Vessel departure from first POL', 'Vessel arrival at T/S port', 'Container discharge at T/S port'
            , 'Container loaded at T/S port', 'Vessel departure from T/S', 'Exp clearance in progress', 'Exp clearance completed'
            , 'Exp clearance in progress', 'Exp clearance completed', 'Imp clearance in progress', 'Imp clearance completed'
...
WebUI.callTestCase(findTestCase('Scenario 10/S10_TC117-BU Auto Generate Cargo Tracking Detail/S10_TC117.4-BU Cargo Tracking (NYKU8417026)'), 
    [('milestone') : ['Booking Submitted', 'Booking Confirmed', 'Empty Container Release to Shipper', 'Cargo Outbound', 'Gate in (arrival at first POL)'
            , 'Container loaded at first POL', 'Vessel departure from first POL', 'Vessel arrival at T/S port', 'Container discharge at T/S port'
            , 'Container loaded at T/S port', 'Vessel departure from T/S', 'Exp clearance in progress', 'Exp clearance completed'
            , 'Exp clearance in progress', 'Exp clearance completed', 'Imp clearance in progress', 'Imp clearance completed'
