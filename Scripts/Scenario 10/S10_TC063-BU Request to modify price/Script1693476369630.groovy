...
for (int index = 1; index <= testData.getRowNumbers(); index++) {
    for (def pair : columnname) {
        ...
        CustomKeywords.'copyToExcel.exel3'(dataString, rowExcel, columnIndex, latestPath, 'Contract Price')
    }
}
...
CustomKeywords.'copyToExcel.exel4'(requestList, 1, 4, 'Excel Files/Scenario 10/S10_TestCases_Data.xlsx', 'TC063')
