...
WebUI.callTestCase(findTestCase('0-Common/Common-Scenario 10/S10_TC011_Cmn_1-Input Received Req Add New Part (Part 3)'), 
    [('deliveryTo') : deliveryTo, ('confirmOrderLeadtime') : confirmOrderLeadtime, ('leadTime') : leadTime, ('deliveryPlanStartDate') : deliveryPlanStartDate
        ...
        , ('receiveDc') : receiveDc, ('shippingRouteCode') : shippingRouteCode, ('customsFlag') : customsFlag, ('contractDescription') : contractDescription], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('0-Common/Common-Scenario 10/S10_TC011_Cmn_2-Get Contract Route Code (SUP1)'), [('contractRouteCodeIndex') : 14
