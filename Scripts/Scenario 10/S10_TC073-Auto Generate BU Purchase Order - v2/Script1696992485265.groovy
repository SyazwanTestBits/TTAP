...
not_run: searchString = ((contractELA + ' ') + contractYAZ)
...
for (int row = 1; row <= testData.getRowNumbers(); row++) {
    ...
    CustomKeywords.'copyToExcel.exel4'(orderNo, row, 0, 'Excel Files/Scenario 10/S10_TestCases_Data.xlsx', 'TC073 AutoGen')
