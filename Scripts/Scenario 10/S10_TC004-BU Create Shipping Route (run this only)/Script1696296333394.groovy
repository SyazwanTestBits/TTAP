...
'Input ETD days, Trasport days and verify ETA days'
WebUI.callTestCase(findTestCase('0-Common/Common-ShippingRoute/Create Shipping Route ETD TransportDay ETA'), [('TransportDays') : TransportDays
        , ('EtdWeekDay') : EtdWeekDay], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('0-Common/Common-ShippingRoute/Create Shipping Route SF Week'), [('ShippingFrequency') : ShippingFrequency], 
    FailureHandling.STOP_ON_FAILURE)
