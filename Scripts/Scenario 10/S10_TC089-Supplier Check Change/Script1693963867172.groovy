...
WebUI.verifyElementText(findTestObject('Scenario 12/SC12_TC026/p_verifyOrderChange', [('requestNo') : requestNo]), 'Propose New')

WebUI.click(findTestObject('Scenario 12/SC12_TC019/p_detailButton', [('requestNo') : requestNo]))

WebUI.scrollToElement(findTestObject('Scenario 12/SC12_TC026/p_Parts No sort'), 0)
