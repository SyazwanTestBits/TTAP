...
WebUI.waitForElementPresent(findTestObject('Scenario 10/S10_TC060/h3_Received Request Modify Packing'), 0)

not_run: WebUI.getAttribute(findTestObject('Scenario 10/S10_TC060/input_Reject_requestNo'), 'value')

not_run: CustomKeywords.'copyToExcel.exel3'(findTestObject(null), 0, 0, '', '')
