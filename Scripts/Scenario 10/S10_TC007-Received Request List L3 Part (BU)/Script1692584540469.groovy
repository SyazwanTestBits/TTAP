...
WebUI.callTestCase(findTestCase('0-Common/Common-Scenario 10/S10_TC007_Cmn_1-Input Received Req Add New Part (Part 3)'), 
    [('businessType') : businessType, ('orderFrequency') : orderFrequency, ('forecastNumber') : forecastNumber, ('targetLeadtime') : targetLeadtime
        ...
        , ('routeDescription') : routeDescription, ('seller1Description') : seller1Description, ('seller2Description') : seller2Description], 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('0-Common/Common-Scenario 10/S10_TC007_Cmn_2-Get Contract Route Code'), [('routeDescription') : routeDescription
        , ('contractRouteCodeIndex') : 16, ('filepath') : 'Excel Files\\Scenario 10', ('filename') : 'S10_TestCases_Data.xlsx'
        , ('sheetname') : 'TC007-Received Req Info'], FailureHandling.STOP_ON_FAILURE)
