...
WebUI.setText(findTestObject('Scenario 10/S10_TC077/input_Upload_SaleOrderNo'), SaleNo)

WebUI.setText(findTestObject('Scenario 10/S10_TC077/input_Upload_PurchaseOrderNo'), PurchaseNo)
...
absolutePath = CustomKeywords.'ManageFiles.getFileAbsolutePath'(uploadNew)
