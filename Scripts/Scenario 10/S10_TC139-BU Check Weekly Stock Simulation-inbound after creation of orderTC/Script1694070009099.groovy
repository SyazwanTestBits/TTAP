...
WebUI.click(findTestObject('Scenario 10/S10_TC026/button_Include Plan'))
...
not_run: CustomKeywords.'util.convertXLSMtoXLSX.xlsxWithName'(latestPath, pathExport)

not_run: WebUI.verifyCheckpoint(findCheckpoint('null'), true)
