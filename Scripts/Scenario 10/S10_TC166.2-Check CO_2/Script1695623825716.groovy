...
int numberrowtd = findTestData('Scenario 10/S10_TC166-Customer Check CO_2').getRowNumbers()

for (int rowl = 1; rowl <= numberrowtd; rowl++) {
    int coll = 1

    for (String colname : columnname) {
        String valuecol = findTestData('Scenario 10/S10_TC166-Customer Check CO_2').getValue(colname, rowl)
