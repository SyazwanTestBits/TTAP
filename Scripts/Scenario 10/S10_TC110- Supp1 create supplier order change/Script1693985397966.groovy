...
def mapKeyandColIndex = [('New Firm') : 15, ('InboundNewDate_Qty1') : lastdate, ('InboundNewDate_Qty2') : lastdate + 1]
...
for (int index : (1..testData.getRowNumbers())) {
    ...
    for (def pair : mapKeyandColIndex) {
        ...
        CustomKeywords.'copyToExcel.exelSheetNumber2'(dataValue, fileRowIndex, columnIndex, latestPath, 0)
    }
}
