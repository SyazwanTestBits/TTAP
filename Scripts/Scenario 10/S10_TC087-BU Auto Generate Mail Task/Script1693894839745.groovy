...
def OrderNo = PO_number

println(OrderNo)

//Validate actualText against expectedText
def expectedText = "Dear PNA Technologies Sdn Bhd, You have received change/cancel request for below order: $OrderNo Please login to the system to check and approve the request. Thank you for your continued support! Best regards."
