...
for (def index : (1..dataFile.getRowNumbers())) {
    'Write - Unit Parts No'
    CustomKeywords.'copyToExcel.exel3'(findTestData('Scenario 10/S10_TC005').getValue(2, index), index + 6, 0, downloadedExcel, 
        'INPUT PART INFO')

    'Write - Parts No.'
    CustomKeywords.'copyToExcel.exel3'(findTestData('Scenario 10/S10_TC005').getValue(3, index), index + 6, 1, downloadedExcel, 
        'INPUT PART INFO')

    'Write - Unit Parts Description'
    CustomKeywords.'copyToExcel.exel3'(findTestData('Scenario 10/S10_TC005').getValue(4, index), index + 6, 2, downloadedExcel, 
        'INPUT PART INFO')

    'Write - Parts Ref No.'
    CustomKeywords.'copyToExcel.exel3'(findTestData('Scenario 10/S10_TC005').getValue(5, index), index + 6, 3, downloadedExcel, 
        'INPUT PART INFO')

    'Write - Back No.'
    CustomKeywords.'copyToExcel.exel3'(findTestData('Scenario 10/S10_TC005').getValue(6, index), index + 6, 4, downloadedExcel, 
        'INPUT PART INFO')

    'Write - HS Code'
    CustomKeywords.'copyToExcel.exel3'(findTestData('Scenario 10/S10_TC005').getValue(7, index), index + 6, 5, downloadedExcel, 
        'INPUT PART INFO')

    'Write - UOM Code'
    CustomKeywords.'copyToExcel.exel3'(findTestData('Scenario 10/S10_TC005').getValue(8, index), index + 6, 6, downloadedExcel, 
        'INPUT PART INFO')

    'Write - Paired Parts'
    CustomKeywords.'copyToExcel.exel3'(findTestData('Scenario 10/S10_TC005').getValue(9, index), index + 6, 7, downloadedExcel, 
        'INPUT PART INFO')

    'Write - Unit Parts No. of Paired Parts'
    CustomKeywords.'copyToExcel.exel3'(findTestData('Scenario 10/S10_TC005').getValue(10, index), index + 6, 8, downloadedExcel, 
        'INPUT PART INFO')

    'Write - Paired Order Flag'
    CustomKeywords.'copyToExcel.exel3'(findTestData('Scenario 10/S10_TC005').getValue(11, index), index + 6, 9, downloadedExcel, 
        'INPUT PART INFO')

    'Write - Order Lot'
    CustomKeywords.'copyToExcel.exel3'(findTestData('Scenario 10/S10_TC005').getValue(12, index), index + 6, 10, downloadedExcel, 
        'INPUT PART INFO')

    'Write - SPQ'
    CustomKeywords.'copyToExcel.exel3'(findTestData('Scenario 10/S10_TC005').getValue(13, index), index + 6, 11, downloadedExcel, 
        'INPUT PART INFO')

    'Write - M3'
    CustomKeywords.'copyToExcel.exel3'(findTestData('Scenario 10/S10_TC005').getValue(14, index), index + 6, 12, downloadedExcel, 
        'INPUT PART INFO')

    'Write - Net Weight'
    CustomKeywords.'copyToExcel.exel3'(findTestData('Scenario 10/S10_TC005').getValue(15, index), index + 6, 13, downloadedExcel, 
        'INPUT PART INFO')

    'Write - Gross Weight'
    CustomKeywords.'copyToExcel.exel3'(findTestData('Scenario 10/S10_TC005').getValue(16, index), index + 6, 14, downloadedExcel, 
        'INPUT PART INFO')
}
