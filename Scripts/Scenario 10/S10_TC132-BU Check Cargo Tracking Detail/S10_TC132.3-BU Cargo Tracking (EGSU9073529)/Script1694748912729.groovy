...
for (int row = 3; row <= 3; row++) {
    ...
    String bookingNo = findTestData('Data Files/Scenario 10/S10_TC132-BU Check Cargo Tracking').getValue('BookingNo', 
        row)

    String contnum2 = findTestData('Data Files/Scenario 10/S10_TC132-BU Check Cargo Tracking').getValue('ContainerNo', 
        row)
    ...
    String trackType = findTestData('Data Files/Scenario 10/S10_TC132-BU Check Cargo Tracking').getValue('TrackingType', 
        row)
    ...
    for (String milestonecol : milestone) {
        String sytle2 = findTestData('Data Files/Scenario 10/S10_TC132-BU Check Cargo Tracking').getValue(milestonecol, 
            row)
