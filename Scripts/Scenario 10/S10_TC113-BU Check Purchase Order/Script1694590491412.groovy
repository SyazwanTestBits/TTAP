...
WebUI.setText(findTestObject('Scenario 12/SC12_TC014/input_contractNo'), spotPurchaseOrderNo)
...
WebUI.verifyElementText(findTestObject('Scenario 10/S10_TC078/p_verifyStatus', [('PO') : spotPurchaseOrderNo]), 'Processing')
...
WebUI.scrollToElement(findTestObject('Scenario 10/S10_TC078/div_Parts No'), 0)
...
int numberrowtd = findTestData('Scenario 10/S10_TC113-BU Check PO').getRowNumbers()

for (int rowl = 1; rowl <= numberrowtd; rowl++) {
    colindex = 1

    for (String colname : columnname) {
        String valuecol = findTestData('Scenario 10/S10_TC113-BU Check PO').getValue(colname, rowl)
