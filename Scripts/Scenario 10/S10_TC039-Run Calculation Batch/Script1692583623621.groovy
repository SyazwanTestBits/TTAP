...
WebUI.verifyElementPresent(findTestObject('Scenario 13/S13_TC039/div_Run ETL Data Processing.The operation was successful'), 
    0)
...
WebUI.click(findTestObject('Scenario 13/S13_TC039/li_STEP 3PROCESS PNA WIP'))

WebUI.delay(1)

not_run: WebUI.verifyElementPresent(findTestObject('Scenario 13/S13_TC039/div_post smt-apietlsyncEtlForPnaWipThe operation was successful'), 
    0)
