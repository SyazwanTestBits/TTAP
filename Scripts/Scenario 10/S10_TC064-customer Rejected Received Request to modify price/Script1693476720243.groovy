...
WebUI.waitForElementPresent(findTestObject('Scenario 10/S10_TC062/h3_View Received Request Modify Price'), 0)
...
for (int index = 1; index <= testData.getRowNumbers(); index++) {
    for (def pair : columnname) {
        ...
        WebUI.verifyElementText(findTestObject('Scenario 10/S10_TC060/div_part detail-dt', [('row') : index, ('col') : columnIndex]), 
            dataString)
    }
}

CustomKeywords.'util.ScrollToElement.clickUsingJS'(findTestObject('Scenario 10/S10_TC064/button_recieved request-Reject'), 
    0)

WebUI.setText(findTestObject('Scenario 10/S10_TC064/input_Do you want to reject this request_rejectReason'), reasonReject)

WebUI.click(findTestObject('Scenario 10/S10_TC064/button_receive-Reject-reject new'))
...
WebUI.verifyElementNotPresent(findTestObject('Scenario 10/S10_TC060/div_recceived-dt-status'), 0)
