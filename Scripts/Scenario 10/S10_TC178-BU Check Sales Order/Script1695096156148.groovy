...
WebUI.callTestCase(findTestCase('Scenario 10/S10_TC178.1-Check SO_1'), [('SO_numberList') : SO_numberList, ('contractNoL2') : findTestData(
            'Scenario 10/S10_ContractList').getValue(2, 2), ('columnname') : ['PartsNo', 'UnitPartsNo', 'BackNo', 'POnumber'
            , 'Customer', 'SPQ', 'OrderLot', 'OrderQty', 'UnitPrice', 'Currency', 'Status', 'DeliveredQty', 'InTransitQty'
            , 'InboundedQty', 'InboundedPlanQty', 'InboundedPlanStatus']], FailureHandling.STOP_ON_FAILURE)

CustomKeywords.'util.ScrollToElement.clickUsingJS'(findTestObject('Scenario 10/S10_TC178/p_SO Monitoring List'), 0)

WebUI.callTestCase(findTestCase('Scenario 10/S10_TC178.2-Check SO_2'), [('SO_numberList') : SO_numberList, ('contractNoL2') : findTestData(
            'Scenario 10/S10_ContractList').getValue(2, 2), ('columnname') : ['PartsNo', 'UnitPartsNo', 'BackNo', 'POnumber'
            , 'Customer', 'SPQ', 'OrderLot', 'OrderQty', 'UnitPrice', 'Currency', 'Status', 'DeliveredQty', 'InTransitQty'
            , 'InboundedQty', 'InboundedPlanQty', 'InboundedPlanStatus']], FailureHandling.STOP_ON_FAILURE)
