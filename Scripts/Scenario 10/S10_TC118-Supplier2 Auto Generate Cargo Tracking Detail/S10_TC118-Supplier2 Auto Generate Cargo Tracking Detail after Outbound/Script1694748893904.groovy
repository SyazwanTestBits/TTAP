...
WebUI.callTestCase(findTestCase('Scenario 10/S10_TC118-Supplier2 Auto Generate Cargo Tracking Detail/S10_TC118.1-Supplier2 Cargo Tracking (Bs2-NT-01-001 C-230608001)'), [('milestone') : [
            'Booking Submitted', 'Booking Confirmed', 'Empty Container Release to Shipper', 'Cargo Outbound', 'Gate in (arrival at first POL)'
        ...
        , ('bookingNo') : findTestData('Scenario 10/S10_TC115-Supplier2 Outbound').getValue('BookingNo', 1)], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Scenario 10/S10_TC118-Supplier2 Auto Generate Cargo Tracking Detail/S10_TC118.2-Supplier2 Cargo Tracking (JP-YAZ-C-230608001)'), [('milestone') : ['Booking Submitted'
            , 'Booking Confirmed', 'Empty Container Release to Shipper', 'Cargo Outbound', 'Gate in (arrival at first POL)'
            , 'Container loaded at first POL', 'Vessel departure from first POL', 'Vessel arrival at T/S port', 'Container discharge at T/S port'
            , 'Container loaded at T/S port', 'Vessel departure from T/S', 'Exp clearance in progress', 'Exp clearance completed'
            , 'Exp clearance in progress', 'Exp clearance completed', 'Imp clearance in progress', 'Imp clearance completed'
            , 'Imp clearance in progress', 'Imp clearance completed', 'Vessel arrived at final POD (ATA)', 'Container unload at final POD'
            ...
            , 'Departure (Departure from Transhipment Port)', 'Arrival (vessel Arrival at Port of Discharging)', 'Unload (Unloaded from vessel at Port of Discharging)'
            , 'Gate out (Gate Out from Inbound Terminal for Delivery to Consignee (or Port Shuttle))', 'Empty container returned (Empty Container Returned from Customer)']
        , ('containerNo') : findTestData('Scenario 10/S10_TC117-BU Auto Generate Cargo Tracking').getValue('ContainerNo', 
...
WebUI.callTestCase(findTestCase('Scenario 10/S10_TC118-Supplier2 Auto Generate Cargo Tracking Detail/S10_TC118.3-Supplier2 Cargo Tracking (EGSU9073529)'), [('milestone') : ['Booking Submitted'
            , 'Booking Confirmed', 'Empty Container Release to Shipper', 'Cargo Outbound', 'Gate in (arrival at first POL)'
            , 'Container loaded at first POL', 'Vessel departure from first POL', 'Vessel arrival at T/S port', 'Container discharge at T/S port'
            , 'Container loaded at T/S port', 'Vessel departure from T/S', 'Exp clearance in progress', 'Exp clearance completed'
            , 'Exp clearance in progress', 'Exp clearance completed', 'Imp clearance in progress', 'Imp clearance completed'
...
WebUI.callTestCase(findTestCase('Scenario 10/S10_TC118-Supplier2 Auto Generate Cargo Tracking Detail/S10_TC118.4-Supplier2 Cargo Tracking (NYKU8417026)'), [('milestone') : ['Booking Submitted'
            , 'Booking Confirmed', 'Empty Container Release to Shipper', 'Cargo Outbound', 'Gate in (arrival at first POL)'
            , 'Container loaded at first POL', 'Vessel departure from first POL', 'Vessel arrival at T/S port', 'Container discharge at T/S port'
            , 'Container loaded at T/S port', 'Vessel departure from T/S', 'Exp clearance in progress', 'Exp clearance completed'
            , 'Exp clearance in progress', 'Exp clearance completed', 'Imp clearance in progress', 'Imp clearance completed'
