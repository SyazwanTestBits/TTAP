...
WebUI.verifyElementPresent(findTestObject('Scenario 10/S10_TC058/p_The parts SPQ of buyer is not the same as contract part SPQ when Repacking Type is non Repacking (Contract part SPQ  10).(the 1 row)(w0576)'), 
    0)
