...
for (int row2 = 1; row2 <= testData.getRowNumbers(); row2++) {
	...
	String COid = testData.getValue('COid', row2)

	String buttonClickPONo = 'Order Number: ' + COid

	WebUI.setText(findTestObject('Scenario 13/S13_TC064,065/input_Search booking no'), COid)
