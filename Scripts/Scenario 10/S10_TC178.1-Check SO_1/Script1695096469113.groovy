...
int numberrowtd = findTestData('Scenario 10/S10_TC178-BU Check SO_1').getRowNumbers()

for (int rowl = 1; rowl <= numberrowtd; rowl++) {
    int coll = 1

    for (String colname : columnname) {
        String valuecol = findTestData('Scenario 10/S10_TC178-BU Check SO_1').getValue(colname, rowl)
