...
WebUI.setText(findTestObject('Page_ReceivedReqList/input_Search_ReceivedReqList'), requestID)

WebUI.click(findTestObject('Page_ReceivedReqList/td_ReceivedReqList_ReqEdit', [('requestNo') : requestID]))
