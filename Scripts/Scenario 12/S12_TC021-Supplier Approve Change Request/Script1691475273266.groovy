...
//
not_run: WebUI.click(findTestObject('Scenario 12/SC12_TC021/span_Approve'))

CustomKeywords.'util.ScrollToElement.clickUsingJS'(findTestObject('Scenario 12/SC12_TC021/span_Approve'), 0)
