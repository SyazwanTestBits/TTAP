...
WebUI.callTestCase(findTestCase('Scenario 12/S12_TC011.1-Customer Place Order -Regular'), [('contractRouteNo') : findTestData(
            'Scenario 12/SC12_TC007-Supplier to BU Contract').getValue('ContractRouteCode', 1), ('contractNo') : findTestData(
            'Scenario 12/SC12_TC004-BU to Customer Contract').getValue('ContractNo', 1), ('weeklyPeriod') : findTestData(
            'Scenario 12/SC12_TC011- Period Generator').getValue('Auto Generate Weekly Period', 1)], FailureHandling.STOP_ON_FAILURE)
