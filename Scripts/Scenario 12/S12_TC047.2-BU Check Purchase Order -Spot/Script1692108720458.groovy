...
WebUI.click(findTestObject('Scenario 12/SC12_TC047/p_detailButton', [('POid') : spotPurchaseOrderNo]))

WebUI.waitForElementPresent(findTestObject('Page_PO_MonitoringDetail/h3_PO Monitoring Detail'), 0)

WebUI.verifyElementAttributeValue(findTestObject('Page_PO_MonitoringDetail/input_PurchaseOrderNo'), 'value', spotPurchaseOrderNo, 
    0)
...
WebUI.click(findTestObject('Scenario 12/SC12_TC046/p_checkbox', [('SOid') : spotPurchaseOrderNo]))
