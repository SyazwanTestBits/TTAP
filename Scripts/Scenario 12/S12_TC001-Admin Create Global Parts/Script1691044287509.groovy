...
WebUI.callTestCase(findTestCase('0-Common/Common-Scenario 12/S12_Cmn2-Write Info into Form Excel_Latest'), [('datafile') : globalPartsData
        , ('fileColumns') : filecolumn, ('startRowFormMinusOne') : 6, ('downloadedFormPath') : downloadedFile, ('downloadedFormSheetname') : 'Global Parts'], 
    FailureHandling.STOP_ON_FAILURE)

absolute_globalpart_path = CustomKeywords.'ManageFiles.getFileAbsolutePath'(downloadedFile)
