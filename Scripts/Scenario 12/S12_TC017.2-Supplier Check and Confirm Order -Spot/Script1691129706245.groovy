...
int numberrowtd = findTestData('Scenario 12/SC12_TC017-Supplier Check and Confirm SO -Spot').getRowNumbers()

for (int rowl = 1; rowl <= numberrowtd; rowl++) {
    int coll = 1

    for (String col : columnnameSpot) {
        String valuecol = findTestData('Scenario 12/SC12_TC017-Supplier Check and Confirm SO -Spot').getValue(col, rowl)
...
WebUI.click(findTestObject('Scenario 12/SC12_TC017/button_CONFIRMnotiSpot'))
