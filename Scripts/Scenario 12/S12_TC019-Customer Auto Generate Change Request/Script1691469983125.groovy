...
int numberrowtd = findTestData('Scenario 12/SC12_TC019-Customer Forecast Change Info').getRowNumbers()

for (int rowl = 1; rowl <= numberrowtd; rowl++) {
    int coll = 1

    for (String col : columnname) {
        String valuecol = findTestData('Scenario 12/SC12_TC019-Customer Forecast Change Info').getValue(col, rowl)
