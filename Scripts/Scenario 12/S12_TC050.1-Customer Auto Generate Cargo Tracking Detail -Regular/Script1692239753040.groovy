...
int rownum = findTestData('Scenario 12/SC12_TC050.1-Cargo Tracking Detail -Regular').getRowNumbers()

String buttonClickOrderNo = 'Order Number: ' + RegularOrderNo

WebUI.setText(findTestObject('Scenario 12/SC12_TC050/input_Search OrderNo'), RegularOrderNo)
...
for (int row = 1; row <= rownum; row++) {
    String bookingNo = findTestData('Data Files/Scenario 12/SC12_TC050.1-Cargo Tracking Detail -Regular').getValue('BookingId', row)

    String contnum2 = findTestData('Data Files/Scenario 12/SC12_TC050.1-Cargo Tracking Detail -Regular').getValue('ContainerNo', 
        row)
    ...
    String trackType = findTestData('Data Files/Scenario 12/SC12_TC050.1-Cargo Tracking Detail -Regular').getValue('TrackingType', 
        row)
    ...
    for (String milestonecol : milestone) {
        String sytle2 = findTestData('Data Files/Scenario 12/SC12_TC050.1-Cargo Tracking Detail -Regular').getValue(milestonecol, 
            row)
