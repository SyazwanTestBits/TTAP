...
def expectedText = "Dear BAFCO SINGAPORE PTE. LTD., You have received change/cancel request for below order: ${regularSalesOrderNo} Please login to the system to check and approve the request. Thank you for your continued support! Best regards."
