...
'Login and change company to VN-TTVN'
...
WebUI.callTestCase(findTestCase('0-Common/Common-Scenario 12/S12_Cmn2-Write Info into Form Excel_Latest'), [('datafile') : requestPartsData
        , ('fileColumns') : fileColumns, ('startRowFormMinusOne') : 6, ('downloadedFormPath') : downloadedExcel, ('downloadedFormSheetname') : 'INPUT PART INFO'], 
    FailureHandling.STOP_ON_FAILURE)
