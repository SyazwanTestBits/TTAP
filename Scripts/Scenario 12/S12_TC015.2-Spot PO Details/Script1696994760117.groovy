...
WebUI.click(findTestObject('Scenario 12/SC12_TC014/p_detailsButton', [('SOnumber') : spotPurchaseOrderNo]))

WebUI.waitForElementPresent(findTestObject('Page_PO_MonitoringDetail/h3_PO Monitoring Detail'), 0)

WebUI.verifyElementAttributeValue(findTestObject('Page_SO_MonitoringDetail/input_SalesOrderNo'), 'value', spotPurchaseOrderNo, 
    0)
...
WebUI.verifyElementAttributeValue(findTestObject('Scenario 12/SC12_TC014/Page_PO Monitoring Detail - Brivge/input_Basic Info_seller'), 
    'value', GlobalVariable.BAF_COMPANY_SUP, 0)
