...
WebUI.callTestCase(findTestCase('Scenario 12/S12_TC016.1-Regular SO Details'), [('contractNo') : findTestData('Scenario 12/SC12_TC007-Supplier to BU Contract').getValue(
            'ContractNo', 1), ('regularSalesOrderNo') : findTestData('Scenario 12/SC12_TC016-Supplier SO').getValue('RegularSalesOrderNo', 
            1), ('spotSalesOrderNo') : findTestData('Scenario 12/SC12_TC016-Supplier SO').getValue('SpotSalesOrderNo', 1)
        , ('paymentTermsDesc') : findTestData('Scenario 12/SC12_TC003.1-BU Create Payment Terms').getValue('Description', 
            1)], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Scenario 12/S12_TC016.2-Spot SO Details'), [('contractNo') : findTestData('Scenario 12/SC12_TC007-Supplier to BU Contract').getValue(
            'ContractNo', 1), ('regularSalesOrderNo') : findTestData('Scenario 12/SC12_TC016-Supplier SO').getValue('RegularSalesOrderNo', 
            1), ('spotSalesOrderNo') : findTestData('Scenario 12/SC12_TC016-Supplier SO').getValue('SpotSalesOrderNo', 1)
        , ('paymentTermsDesc') : findTestData('Scenario 12/SC12_TC003.1-BU Create Payment Terms').getValue('Description', 
            1)], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Scenario 12/S12_TC016.3-Forecast Details'), [('contractNo') : findTestData('Scenario 12/SC12_TC007-Supplier to BU Contract').getValue('ContractNo', 1)
