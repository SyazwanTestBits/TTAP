...
WebUI.callTestCase(findTestCase('Scenario 12/S12_TC050.1-Customer Auto Generate Cargo Tracking Detail -Regular'), [('milestone') : [
        ...
        , ('RegularOrderNo') : findTestData('Scenario 12/SC12_TC011-CO Number').getValue('RegularCustomerOrderNo', 1), ('SpotOrderNo') : findTestData(
            'Scenario 12/SC12_TC011-CO Number').getValue('SpotCustomerOrderNo', 1)], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Scenario 12/S12_TC050.2-Customer Auto Generate Cargo Tracking Detail -Spot'), [('milestone') : [
            'Booking Submitted', 'Booking Confirmed', 'Empty Container Release to Shipper', 'Cargo Outbound', 'Gate in (arrival at first POL)'
            , 'Container loaded at first POL', 'Vessel departure from first POL', 'Vessel arrival at T/S port', 'Container discharge at T/S port'
            , 'Container loaded at T/S port', 'Vessel departure from T/S', 'Exp clearance in progress', 'Exp clearance completed'
            , 'Exp clearance in progress', 'Exp clearance completed', 'Imp clearance in progress', 'Imp clearance completed'
