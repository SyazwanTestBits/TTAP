...
int numberrowtd = findTestData('Scenario 12/SC12_TC032-Supplier Check SO Regular').getRowNumbers()

for (int rowl = 1; rowl <= numberrowtd; rowl++) {
    int coll = 1

    for (String colname : columnname) {
        String valuecol = findTestData('Scenario 12/SC12_TC032-Supplier Check SO Regular').getValue(colname, rowl)
