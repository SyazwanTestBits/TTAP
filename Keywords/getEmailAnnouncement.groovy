...
public class getEmailAnnouncement {
	...
	static String extract() {
		...
		Message[] messages = inbox.search(new SubjectTerm("What's New on Brivge"))
	...
	@Keyword
	static String extractInputEmail(String email, String appPass) {
		// Email account credentials
