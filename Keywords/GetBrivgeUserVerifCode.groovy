...
public class GetBrivgeUserVerifCode {
	...
	public static void main(String[] args) {
		extractUserVerifCode()
	}

	// Keyword to extract user verification codes
	@Keyword
	static String extractUserVerifCode() {
