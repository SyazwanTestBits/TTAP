...
public class GetLatestEmailByDesiredIndex {
	...
	@Keyword
	static String extract(String email, String pass, String subjectName, int desiredIndex) {
		...
		//Get latest Message based on Index

		if (desiredIndex >= 0 && desiredIndex < messages.length) {

			Message latestMessage = messages[messages.length - 1 - desiredIndex];
